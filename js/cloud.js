...
const LOCAL_ONLY_SETTINGS = new Set([
  ...
  /* המפתח הישן והיחיד של מנוי Push: נשאר מקומי, כתאימות לאחור בלבד.
     מנויים חדשים נשמרים ב-'pushSub_<מזהה מכשיר>' (ראה push.js) ודווקא
     כן מסתנכרנים — הסקריפט בענן קורא אותם משם, ובגלל המזהה מכשיר ב'
